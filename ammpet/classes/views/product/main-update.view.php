...
<div class="container-fluid">
    ...
    <form method="post" id="form_prod" name="form_update">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <input id="button" class="btn btn-primary btn-lg m-1 btn-block" type="submit" value="Atualizar" formaction="../Product/update_call">
            </div>
        </div>
    </form>
