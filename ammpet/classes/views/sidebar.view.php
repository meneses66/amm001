<div class="sidebar-heading border-bottom bg-light">ABC System</div>
  <div class="list-group list-group-flush">
      ...
      <a class="list-group-item list-group-item-action <?php if(URL_0=='Home' && URL_1=='create') echo 'active';?> list-group-item-light p-3" href="?run=create">Cadastros</a>
      <a class="list-group-item list-group-item-action <?php if(URL_0=='Home' && URL_1=='search') echo 'active';?> list-group-item-light p-3" href="?run=search">Consultas</a>
      <a class="list-group-item list-group-item-action <?php if(URL_0=='Home' && URL_1=='report') echo 'active';?> list-group-item-light p-3" href="?run=report">Relatórios</a>
