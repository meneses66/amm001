...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-6">
            <?php ((check_permission($_SESSION['username'],"payments_add"))? print_r("<a href=\"". ROOT."/Payments/_new?id=new\" class=\"btn btn-success m-1 float-right\"><i class=\"fas fa-plus-circle\"></i>&nbsp;Novo Custo</a>") : print_r(""))?>
        </div>
        <hr class="my-1">
    <div class="row">
