...
<div class="container-fluid">
    ...
    <br><br><br><br>
    <div class="row">
        <div class="col-sm-6"><a href="<?php echo ROOT."/Client/_list";?>" class="btn btn-primary btn-lg m-1 btn-block" id="button_client_list"><i class="fas fa-user"></i>&nbsp;Clientes</a></div>
