        ...
        if($data){
            ...
            $output .='<thead>
                            <tr class="text-center text-secondary">
                                ...
                                <th>Ações</th>
                                <th style="padding: 0;">Criado por</th>
                                <th style="padding: 0;">Atualizado por</th>
                                <th style="padding: 0;">Temp_Id_Employee</th>
                                <th style="padding: 0;">Id Funcionário</th>
                            </tr>
                        </thead>
                        <tbody>';
            foreach ($data as $row) {
                ...
                $output .='<tr class="text-center text-secondary">
                            ...
                            <td style="padding: 0;">'.$row->CREATED_BY.'</td>
                            <td style="padding: 0;">'.$row->UPDATED_BY.'</td>
                            <td style="padding: 0;">'.$row->ID_EMPLOYEE.'</td>
                            <td style="padding: 0;">'.$row->ID_EMPLOYEE.'</td>
                        </tr>';
            }
            $output .= '</tbody>';
