            ...
            if($data){
                ...
                $output .= '<div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <input id="client" type="text" size="30" name="Client" readonly value="'.$data_form['NAME'].'">
                                </div>
                                <div class="col-sm-1">
                                    <label for="total_disc" class="medium-label">Total com desc.:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input id="total_disc" type="text" size="30" name="Total_disc" readonly value="'.$data_form['ORDER_VALUE_WITH_DISCOUNT'].'">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <input id="total_cash" type="text" size="30" name="Total_cash" readonly value="'.$data_form['ORDER_VALUE_CASH'].'">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <input id="order_date" type="date" size="8" name="Order_date" readonly value="'.$data_form['ORDER_DATE'].'">
                                </div>
                                <div class="col-sm-1">
                                    <label for="total_pix" class="medium-label">Total Pix:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input id="total_pix" type="text" size="30" name="Total_pix" readonly value="'.$data_form['ORDER_VALUE_PIX'].'">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <input id="status" type="text" size="8" name="Status" readonly value="'.$data_form['STATUS'].'">
                                </div>
                                <div class="col-sm-1">
                                    <label for="total_paid" class="medium-label">Total Pago:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input id="total_paid" type="text" size="30" name="Total_paid" readonly value="'.$data_form['ORDER_PAID_AMOUNT'].'">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <input id="total_debt" type="text" size="30" name="Total_debt" readonly value="'.$data_form['ORDER_DEBT'].'">
                                </div>
                            </div>';
                            echo $output;
            } else{
