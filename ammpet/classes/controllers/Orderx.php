                ...
                foreach ($data as $row) {
                    ...
                    $output .='<tr class="text-center text-secondary">
                                ...
                                <td>
                                    ...
                                    <a href="'.ROOT."/OrderItem/_delete?id=$row->ID".'" title="Delete" class="text-danger deleteOIBtn" id="'.$row->ID.'" order_id="'.$row->ID_ORDER.'" package_id="'.$row->ID_package.'" classforjs="OrderItem"><i class="fas fa-eraser"></i></a>
                                </td>
                               </tr>';
                }
                $output .= '</tbody>';
