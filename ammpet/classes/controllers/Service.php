...
class Service {
    ...
    public function load_service_form(){
        ...
        if (isset($_GET['id'])){
            ...
            if (!($id=='new')) {
                ...
                //FOR EACH DROPDOWN GET $data_form and send to load_options_update to get the selected option
                //$data_form_category = $data_form['CATEGORY'];
                $category_option_list = load_options_update("SERV_CATEGORY", "Ativo", $category);

                //$center = $data_form['CENTER'];
                $center_option_list = load_options_update("SERV_CENTER", "Ativo", $center);
                ...
                $output .= '<div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input id="type" type="hidden" name="Type" value="Serv" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input id="price" type="text" size="10" name="Price" value="'.$price.'" step="0.01" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <select class="medium-label" id="group_x" name="Group_x">
                                        <option class="medium-label" value="Individual" '.(($group_x == 'Individual')?"selected":"").'>Individual</option>
                                        <option class="medium-label" value="Pacote" '.(($group_x == 'Pacote')?"selected":"").'>Pacote</option>
                                    </select>
                                </div>
                                <div class="col-sm-1">
                                    <label for="supplier" class="medium-label">Fornecedor:</label>
                                ...
                                <div class="col-sm-2">
                                    <input id="price_pix" type="text" size="10" name="Price_pix" value="'.$price_pix.'" step="0.01" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-2">
                                    <input id="comission_percentage" type="text" size="10" name="Comission_percentage" value="'.$comission_percentage.'" step="0.01">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-2">
                                    <input id="external_cost" type="text" size="10" name="External_cost" value="'.$external_cost.'" step="0.01">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <input id="package_amount" type="number" size="10" name="Package_amount" value="'.$package_amount.'">
                                </div>
                                <div class="col-sm-1">
                                    <label for="package_price" class="medium-label">Preço Pacote:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input id="package_price" type="text" size="10" name="Package_price" value="'.$package_price.'" step="0.01">
                                </div>
                                <div class="col-sm-1">
                            ...
                            if ($id=="new") {
                                $output .= '<div class="row">
                                                <div class="col-sm-6">
                                                    <a href="'.ROOT.'/Service/_list" class="btn btn-secondary btn-lg m-1 btn-block">Voltar</a>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input id="button" class="btn btn-primary btn-lg m-1 btn-block" type="save_submit" value="Salvar" formaction="../Service/insert_call">
                                                </div>
                                            </div>';
                            } else {
                                $output .= '<div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="button" class="btn btn-primary btn-lg m-1 btn-block" type="save_submit" value="Salvar" formaction="../Service/update_call?id='.$id.'">
                                                </div>
                                            </div>';
                            }
            ...
            foreach ($data as $row) {
                ...
                */
                ...
                $output .='<tr class="text-center text-secondary">
                            ...
                            <td>
                                '.(($inputs_buttons == $this->OrderItem && $orderitem_add_check) ? '<a href="' . ROOT . '/OrderItem/_insert_service?cli_id=' . esc($inputs_cli_id) . '&order_id=' . esc($inputs_order_id) . '&service={' . $array . '}" title="New_Service" class="text-primary newOrderBtn" cli_id="' . $inputs_cli_id . '" order_id="' . $inputs_order_id . '"><i class="fas fa-plus"></i></a>' : '').'
                                '.(($inputs_buttons == $this->UCF_object && $service_edit_check) ? '<a href="' . ROOT . '/' . $this->UCF_object . '/_new?id=' . esc($row->ID) . '" title="Edit" class="text-primary updateBtn" id="' . $row->ID . '"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;' : '').'
                                '.(($inputs_buttons == $this->UCF_object && $service_delete_check) ? '<a href="' . ROOT . '/' . $this->UCF_object . '/_delete?id=' . esc($row->ID) . '" title="Delete" class="text-danger deleteBtn" id="' . $row->ID . '"><i class="fas fa-eraser"></i></a>' : '').'
                            </td></tr>';
            }
            $output .= '</tbody>
                        <tfoot>
    ...
    //FUNCTION USED TO PRE-VALIDATE SERVICE INFO BEFORE IT'S SUBMITTED
    public function validate_service($inputs){
        $error=0;
        $error_msg="";
        if (isset($inputs['operation'])) {
            ...
            if ( $inputs['Center']==null || $inputs['Center']=="" || $inputs['Center']=="Selecione uma opção" ) {
                $error=1;
                $error_msg .= "Selecione uma opção para \"Centro\".\n";
            }
