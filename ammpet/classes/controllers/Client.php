        ...
        if (isset($_GET['id'])){
            ...
            if($data){
                ...
                $output .= '<div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <a href="'.ROOT."/$this->UCF_object/_cli_animal?cli_id=$id".'" title="Animals" class="list-group-item list-group-item-action list-group-item-info p-3" cli_id="'.$id.'"><i class="fas fa-edit">&nbsp;&nbsp;Animais</i></a>
                                </div>
                                <div class="col-sm-3">
                                    <a href="'.ROOT."/$this->UCF_object/_cli_package?cli_id=$id".'" title="Packages" class="list-group-item list-group-item-action list-group-item-info p-3" cli_id="'.$id.'"><i class="fas fa-edit">&nbsp;&nbsp;Pacotes</i></a>
                                </div>
                                <div class="col-sm-3">
                                    <a href="'.ROOT."/$this->UCF_object/_cli_product?cli_id=$id".'" title="Products" class="list-group-item list-group-item-action list-group-item-info p-3" cli_id="'.$id.'"><i class="fas fa-edit">&nbsp;&nbsp;Produtos</i></a>
                                </div>
                                <div class="col-sm-3">
                                    <a href="'.ROOT."/$this->UCF_object/_cli_service?cli_id=$id".'" title="Services" class="list-group-item list-group-item-action list-group-item-info p-3" cli_id="'.$id.'"><i class="fas fa-edit">&nbsp;&nbsp;Serviços</i></a>
                                </div>
                            </div><br>';
                            echo $output;
            } else{
