            ...
            foreach ($data as $row) {
                $output .='<tr class="text-center text-secondary">
                            ...
                            <td>
                                ...
                                '.(($inputs_buttons=="Client")? "<a href=\"" : "").''.(($inputs_buttons=="Client")? ROOT."/Client/_update?id=$row->ID\"" : "").''.(($inputs_buttons=="Client")? " title=\"Edit\" class=\"text-primary updateBtn\" cli_id=" : "").''.(($inputs_buttons=="Client")? $row->ID : "").''.(($inputs_buttons=="Client")? "id=\"button_client_edit\"><i class=\"fas fa-edit\"></i></a>&nbsp;&nbsp" : "").'
