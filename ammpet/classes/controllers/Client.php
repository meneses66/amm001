        ...
        if($model->countAll()>0){
            ...
            foreach ($data as $row) {
                $output .='<tr class="text-center text-secondary">
                            ...
                            <td>'.$row->ANIMALS.'</td>
                            <td>
                                '.((URL(0)=='Orderx')? print_r("<a href=") : "").''.((URL(0)=='Orderx')? ROOT."/Orderx/insert_call?cli_id=$row->ID" : "").''.((URL(0)=='Orderx')? " title=\"New_Order\" class=\"text-primary newOrderBtn\" cli_id=" : "").''.((URL(0)=='Orderx')? $row->ID : "").''.((URL(0)=='Orderx')? "\"><i class=\"fas fa-donate\"></i></a>&nbsp;&nbsp" : "").'
                                '.((URL(0)=="Client")? print_r("<a href=") : "").''.((URL(0)=="Client")? ROOT."/Client/_update?id=$row->ID" : "").''.((URL(0)=="Client")? " title=\"Edit\" class=\"text-primary updateBtn\" id=" : "").''.((URL(0)=="Client")? $row->ID : "").''.((URL(0)=="Client")? "\"><i class=\"fas fa-donate\"></i></a>&nbsp;&nbsp" : "").'
