...
$output = '<script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                //Function to call Modal for delete ORDER ITEM confirmation and execution - when success reloads table:
                        ...
                        confirmButtonText: "Yes, delete it!"
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    url:"/ammpet/public/Ajax_call",
                                    type: "POST",
                                    data:{del_id:del_id, class:"'.$GLOBALS['classnamejs'].'", method:"delete_call", order_id:order_id, package_id:package_id},
                                    success:function(response){
                                        tr.css(\'background-color\', \'#ff6666\');
                                        reload_rows();
                                    }
